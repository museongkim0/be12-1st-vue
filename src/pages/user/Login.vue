...
<template>
    ...
    <div class="w-full max-w-[26rem] p-4 sm:px-5">
        ...
        <img class="mx-auto size-16" src="/files/images/logo/app-logo.svg" alt="logo">
        <div class="mt-4">
        ...
        <div class="mt-4 flex items-center justify-between space-x-2">
            ...
            <router-link to="/signup" class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">Forgot Password?</router-link>
        </div>
        <router-link to="/main/1" class="btn mt-5 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90 text-center block">
            Sign In
        </router-link>
        <div class="mt-4 text-center text-xs+">
            ...
            <router-link class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" to="/signup">Create account</router-link>
            </p>
        </div>
        </div>
    </div>
